...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Vishwa Kotak\\Desktop\\Psychology courses\\PSY 310\\intentional binding\\intentional binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=34.0, method='random', 
        ...
        trialList=data.importConditions('binding sheet-final.xlsx'),
